...
* Every object in a state of uniform For every action there is an equal and opposite reaction.
...
* Some representation of velocity in your game is vital for objects to move
  ** as new positions are calculated from old positions, velocity and time

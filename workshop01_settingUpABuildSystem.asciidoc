...
== 14. Asking *cmake* to create a Visual Studio Solution
...
=== 14.1 Create a `CMakeLists.txt` file
...
=== 14.2 Explanation of the `CMakeLists.txt` file
...
=== 14.3 Ask Cmake to create a Visual Studio Solution
...
=== 14.4 Use the Visual Studio solution
